...
.avatar{
	...
	<body background="<c:url value="/resources/images/10.gif"></c:url>">
        ...
        <h1>Login Here</h1>
         <c:url var="validateUrl" value="/user/validate" />
            ...
            <button id="confirm_user" type="submit" onclick="return validate()"class="btn btn-primary">Login</button>
             <a href="userRegistration"><button id="confirm_user1" type="button" class="btn btn-primary">Register</button>  </a>  
            </form>
